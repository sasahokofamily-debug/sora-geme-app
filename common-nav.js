(()=>{
'use strict';
if(document.getElementById('shookingCommonNav')) return;
...
#shookingGameExit{position:fixed;right:12px;bottom:12px;z-index:99998;display:inline-flex;padding:11px 14px;border:1px solid #58a6ff;border-radius:12px;background:#0d1117;color:#fff;text-decoration:none;font:900 13px system-ui;box-shadow:0 8px 28px rgba(0,0,0,.4)}
